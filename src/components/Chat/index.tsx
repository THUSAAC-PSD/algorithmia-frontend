...
const Chat = () => {
    ...
    const chatMessages = {
        'aaa': [
            { id: 1, sender: '张三', content: '大家好，麦当劳太好吃了', timestamp: '10:30 AM', isCurrentUser: false },
            { id: 2, sender: '我', content: '肯德基才是最好吃的', timestamp: '10:32 AM', isCurrentUser: true },
        ],
    };
            ...
            <div className="flex-1 flex flex-col">
                ...
                <div className="flex-1 p-6 overflow-auto bg-slate-900">
                    <div className="space-y-4">
                        {chatMessages[activeChat as keyof typeof chatMessages]?.map((msg) => (
                            <div 
                                key={msg.id} 
                            ...
                            >
                                <div className={`max-w-[70%] rounded-lg px-4 py-2 ${
                                    ...
                                    {!msg.isCurrentUser && (
                                        <div className="font-medium text-indigo-400 text-sm mb-1">{msg.sender}</div>
                                    )}
                                    <p>{msg.content}</p>
